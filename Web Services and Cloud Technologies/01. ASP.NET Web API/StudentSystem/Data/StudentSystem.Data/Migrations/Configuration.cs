namespace StudentSystem.Data.Migrations
{
    ...
    public sealed class Configuration : DbMigrationsConfiguration<StudentSystemDbContext>
    {
        ...
        private void SeedLecturers(StudentSystemDbContext context)
        {
        ...
        private void SeedLectures(StudentSystemDbContext context)
        {
        ...
        private void SeedExams(StudentSystemDbContext context)
        {
        ...
        private Course GetDatabasesCourse(StudentSystemDbContext context)
        {
            return context.Courses
                .FirstOrDefault(dbc => dbc.Name == CourseType.Databases);
        }

        private Course GetOOPCourse(StudentSystemDbContext context)
        {
            return context.Courses
