console.group('-----------------------------------------------------------------------------------------------------');
var teodorStudent = new Persons.Student('Teodor Teodorov', '9101012233', 1, '199222');
...
var ivanStudent = new Persons.Student('Ivan Ivanov', '9110102233', 4, '101111');
ivanStudent.addMarks(Education.Discipline.WebDesign, [5, 5, 6, 5, 5]);
var mariaTeacher = new Persons.Teacher('Maria Getova', '6404023233', '20 years', [Education.Discipline.Database, Education.Discipline.Criptography, Education.Discipline.Math]);
var kirilTeacher = new Persons.Teacher('Kiril Petev', '8812129900', '11 months', [Education.Discipline.JavaProgramming]);
...
var computerScienceMajor = new Education.Major(Education.MajorType.ComputerScience, computerScienceStudents);
...
console.groupEnd();
console.group('-----------------------------------------------------------------------------------------------------');
var university = new Education.University('Software University', [mariaTeacher, kirilTeacher]);
...
console.groupEnd();
console.group('-----------------------------------------------------------------------------------------------------');
var exam = new Education.Exam(Education.MajorType.Electronics, Education.Discipline.Math, new Persons.Teacher('Daniel Petrov', '5009162314', '30 years', [Education.Discipline.Math, Education.Discipline.OOP]), [new Persons.Student('Kamelia Koleva', '9104121444', 4, '110033')]);
exam.printExam();
console.log('-----------------------------------------------------------------------------------------------------');
console.groupEnd();
